...
namespace NGTI.Migrations
{
    ...
    [Migration("20201214101703_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NGTI.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NGTI.Models.SoloReservation", b =>
                {
                    b.Property<int>("IdSoloReservation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("NGTI.Models.Teams", b =>
                {
                    b.Property<string>("TeamName")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NGTI.Models.TeamMember", b =>
                {
                    b.HasOne("NGTI.Models.Teams", "Teams")
                        .WithMany("TeamMembers")
                        .HasForeignKey("TeamName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NGTI.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("TeamMembers")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
